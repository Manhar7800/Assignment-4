...
insert into department values(1,'PYTHON');
insert into department values(2,'IT');
insert into department values(3,'MSCIT');


-- insert employee

insert into employee values(101,'Manhar',2);
insert into employee values(102,'jay',1);
insert into employee values(103,'jaydip',2);
insert into employee values(104,'mahaveer',3);
...
-- //first we can add new department
...
-- Lab 2: Use the AVG aggregate function to find the average salary of employees in each department.
 -- //alter the new row emp_sal
 
 alter table employee add emp_sal int;
 
 -- update all row
 
 update employee set emp_sal=10000 where emp_id=101;
 update employee set emp_sal=20000 where emp_id=102;
 update employee set emp_sal=40000 where emp_id=103;
 update employee set emp_sal=500000 where emp_id=104;
...
insert into employee(emp_name,emp_sal,dept_id) value('devraj',75000,2);
...
update employee set emp_name='devraj' where emp_id=104;
/*-----------------------------------------------------------------------------------------------------------------------------------------*/
...
delimiter //
 ...
 if emp_dept= 1 then
 select concat('Employee',employ_id,'work in PYTHON department') as message;
 elseif emp_dept=2 then
select concat('Employee',employ_id,'work in IT department') as message;
elseif emp_dept=3 then
select concat('Employee',employ_id,'work in MSCIT department') as message;
...
insert into employee(emp_name,dept_id,emp_sal) values('jinal',3,17000);
insert into employee(emp_name,dept_id,emp_sal) values('shivam',2,40000);

savepoint sp1;


insert into employee(emp_name,dept_id,emp_sal) values('mahaveersinh',1,40000);
insert into employee(emp_name,dept_id,emp_sal) values('jay',3,20000);
...
insert into employee(emp_name,dept_id,emp_sal) values('mahaveersinh',1,20000);
insert into employee(emp_name,dept_id,emp_sal) values('jay',3,10000);

savepoint sp2;
commit;
insert into employee(emp_name,dept_id,emp_sal) values('devraj',2,20000);
insert into employee(emp_name,dept_id,emp_sal) values('yogesh',4,10000);
